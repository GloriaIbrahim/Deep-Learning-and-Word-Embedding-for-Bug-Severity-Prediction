...
def applyLSTMonMozilla(MozillaVectorsTrain, MozillaVectorsTest, MozillaLabelTrain, MozillaLabelTest, MozillaDoc2VecModel):
    ...
    MozillaLSTMModel.fit(MozillaVectorsTrain, MozillaLabelTrain, batch_size=200, epochs=5)
    ...
    MozillaLSTMModel.save('ClassifiersModels/LSTM_wthEmbedding_mozilla_model_keras.h5')
...
def applyLSTMonEclipse(EclipseVectorsTrain, EclipseVectorsTest, EclipseLabelTrain, EclipseLabelTest, EclipseDoc2VecModel):
    ...
    EclipseLSTMModel.fit(EclipseVectorsTrain, EclipseLabelTrain, batch_size=200, epochs=5)
    ...
    EclipseLSTMModel.save('ClassifiersModels/LSTM_wthEmbedding_eclipse_model_keras.h5')
...
def applyLSTMonBoth(BothVectors, BothLabelEncoded, BothDoc2VecModel):
    ...
    BothLSTMModel.fit(BothVectors, BothLabelEncoded, batch_size=200, epochs=5)

    BothLSTMModel.save('ClassifiersModels/LSTM_wthEmbedding_both_model_keras.h5')
